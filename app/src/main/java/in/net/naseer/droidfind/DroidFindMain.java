...
public class DroidFindMain extends Activity implements OnClickListener,
	...
	private void updateAlertedNumber() {
		...
		if (alertedNum.equals("")) {
			alertedTitle.setText("Sorry phone version not supporting");
			alertedData.setText("");

		} else {
			alertedTitle.setText("Sorry service not available");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addAlertedLayout.setOnLongClickListener(new OnLongClickListener() {
